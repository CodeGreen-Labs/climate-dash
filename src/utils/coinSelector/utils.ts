import type { CoinReturn } from '@/types/coinSelectorTypes'
...
function dustThreshold(output: any, feeRate: bigint) {
  console.log('output, feeRate', output, feeRate)
...
function finalize<T extends Coin, O extends Coin>(
  ...
  if (remainderAfterExtraOutput > dustThreshold({}, feeRate)) {
    outputs = outputs.concat({
      amount: remainderAfterExtraOutput,
    } as unknown as O)
  }
